...
st.set_page_config(page_title="Hitting", layout="wide")
st.title("Hitting")
...
# -----------------------------
# Default hitting filter: only Dartmouth batters
# -----------------------------
batter_team_col = safe_col(df, ["BatterTeam", "HitterTeam", "BatterTeam_px", "HitterTeam_px", "Batter_Team_px", "Hitter_Team_px", "batter_team_px", "hitter_team_px"])
if batter_team_col in df.columns:
    df = df[df[batter_team_col].str.lower().isin(["dartmouth", "intrasquad", "intersquad","big green","dar"])]
